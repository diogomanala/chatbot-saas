-- Script SQL para criar a tabela system_alerts
-- Execute este script diretamente no Supabase SQL Editor

-- Criar a tabela system_alerts
...
CREATE INDEX IF NOT EXISTS idx_system_alerts_correlation_id ON public.system_alerts(correlation_id) WHERE correlation_id IS NOT NULL;
